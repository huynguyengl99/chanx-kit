...
export interface MessagesSnapshotEvent {
  ...
  timestamp?: number | null;
  rawEvent?: unknown | null;
  messages: Array<DeveloperMessage | SystemMessage | AssistantMessage | UserMessage | ToolMessage | ActivityMessage | ReasoningMessage>;
}
...
export interface UserMessage {
  ...
  id: string;
  role: "user";
  content: string | Array<TextInputContent | ImageInputContent | AudioInputContent | VideoInputContent | DocumentInputContent | BinaryInputContent>;
  name?: string | null;
  encryptedValue?: string | null;
  subagentRunId?: string | null;
}
